	...
	.controller('ProgrammationController', function (AppService, $rootScope, $scope, $uibModal) {
		...
		vm.artists = {
			'aglaska': {
				...
				'fb': 'https://www.facebook.com/aglaska/'
			},
			'bambounou': {
				'name': 'Bambounou',
				...
				'fb': 'https://www.facebook.com/bambounou/?fref=ts',
				'sc': 'https://soundcloud.com/bambounou'
			},
			'camionB': {
				'name': 'Camion Bazar',
				...
				'fb': 'https://www.facebook.com/LeCamionBazar/?fref=ts'
			},
			'colJ': {
				'name': 'Col J',
			...
			'desmondD': {
				...
				'fb': 'https://www.facebook.com/desmondmyersmusic/?fref=ts',
				'sc': 'https://soundcloud.com/myers_desmond'
			},
			'einleit': {
				'name': 'Einleit',
				...
				'fb': 'https://www.facebook.com/Einleit/?fref=ts',
				'sc': 'https://soundcloud.com/einleit'
			},
			'gramophilesC': {
				...
				'fb': 'https://www.facebook.com/gramophiles/?fref=ts',
				'sc': 'https://soundcloud.com/gramophiles'
			},
			'houseOfM': {
				'name': 'House Of Moda',
				...
				'fb': 'https://www.facebook.com/houseofmodaparis/?fref=ts'
			},
			'isaacD': {
				'name': 'Isaac Delusion',
				...
				'fb': 'https://www.facebook.com/IsaacDelusion/?fref=ts'
			},
			'judy': {
				'name': 'Judy',
				...
				'fb': 'https://www.facebook.com/wearejudy/?fref=ts',
				'sc': 'https://soundcloud.com/wearejudy'
			},
			'koraJ': {
				'name': 'Kora Jamson',
				...
				'fb': 'https://www.facebook.com/koraJamsonmusic/?fref=ts',
				'sc': 'https://soundcloud.com/korajamson'
			},
			'kudiwa': {
				'name': 'Kudiwa',
				...
				'fb': 'https://www.facebook.com/KudiwaStreet/?fref=ts',
				'sc': 'https://soundcloud.com/kudiwa-street'
			},
			'lazareH': {
				'name': 'Lazare Hoche',
				...
				'fb': 'https://www.facebook.com/ItsLazareHoche/?fref=ts',
				'sc': 'https://soundcloud.com/lazare-hoche'
			},
			'moneyP': {
				'name': 'Money Penny',
				...
				'sc': 'https://soundcloud.com/melimeloland'
			},
			'paradis': {
				'name': 'Paradis',
				...
				'fb': 'https://www.facebook.com/paradisfm/?fref=ts',
				'yt': 'https://www.youtube.com/watch?v=kWhR0RMcdfw'
			},
			'rituel': {
				'name': 'Rituel',
			...
			'romainD': {
				...
				'fb': 'https://www.facebook.com/profile.php?id=100009111273866&fref=ts',
				'sc': 'https://soundcloud.com/dafalgang'
			},
			'secretValueO': {
				...
				'fb': 'https://www.facebook.com/secretvalueorchestra/?fref=ts'
			},
			'teachKidsM': {
				...
				'fb': 'https://www.facebook.com/TeachKidsManners/?fref=ts',
				'sc': 'https://soundcloud.com/teachkidsmanners '
			}
		}
	});
